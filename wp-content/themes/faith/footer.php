...
?>
	...
	<footer class="site-footer" role="contentinfo">
		...
		<div class="wrapper wrapper-copy">
			...
			<p class="copy-ilovewp"><span class="theme-credit"><?php _e( 'Theme by', 'faith' ); ?><a href="http://www.ilovewp.com/" rel="nofollow external designer noopener" class="footer-logo-ilovewp"><img src="<?php echo esc_url($ilovewp_logo); ?>" width="51" height="11" alt="<?php esc_attr_e('Church WordPress Themes', 'faith');?>" /></a></span></p>
