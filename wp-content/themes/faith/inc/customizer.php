...
function faith_customize_register( $wp_customize ) {
	...
	$wp_customize->get_setting( 'blogdescription' )->transport  = 'postMessage';
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'highlight_background_color', array(
			'label'       => __( 'Highlight Background Color', 'faith' ),
			'section'     => 'colors',
		) ) );
	...
	$wp_customize->add_panel( 'faith_panel', array(
		...
		'theme_supports' => '',
		'title'          => esc_html__( 'Theme Options', 'faith' ),
		'description'    => esc_html__( 'Faith Theme Options', 'faith' ),
	) );

	$wp_customize->add_section( 'faith_front_page', array(
		'title'		  => esc_html__( 'Featured Content Blocks', 'faith' ),
		'panel'		  => 'faith_panel',
	) );
		...
		$wp_customize->add_control( 'faith_front_featured_pages', array(
			'label'             => esc_html__( 'Show Featured Pages Slideshow on the Front Page', 'faith' ),
		...
		$wp_customize->add_control( 'faith_front_featured_pages_columns', array(
			'label'             => esc_html__( 'Display Featured Pages (Columns) Section on the Front Page', 'faith' ),
			'section'           => 'faith_front_page',
			'type'              => 'checkbox',
		) );
		...
		$wp_customize->add_control( 'faith_front_featured_pages_columns_excerpt', array(
			'label'             => esc_html__( 'Display page excerpts for featured pages.', 'faith' ),
			'section'           => 'faith_front_page',
			'type'              => 'checkbox',
		) );
	...
	$wp_customize->add_section( 'faith_other_options', array(
		'title'		  => esc_html__( 'Other Options', 'faith' ),
		'panel'		  => 'faith_panel',
	) );
		...
		$wp_customize->add_control( 'faith_single_featured_image', array(
			'label'             => esc_html__( 'Display Featured Image on Post Pages', 'faith' ),
		...
		$wp_customize->add_control( 'faith_single_dynamic_menu', array(
			'label'             => esc_html__( 'Display Auto Menu in Sidebar', 'faith' ),
			'section'           => 'faith_other_options',
		...
		$wp_customize->add_control( 'faith_single_gravatar', array(
			'label'             => esc_html__( 'Display Author Gravatar on Post Pages', 'faith' ),
			'section'           => 'faith_other_options',
			'type'              => 'checkbox',
		) );
	...
	return apply_filters( 'faith_color_schemes', array(
		'default' => array(
			...
			'colors' => array(
				...
				'#b1481b', // [8] highlight background color
			),
		),
	) );
}
